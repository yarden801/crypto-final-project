...
from py_ecc.optimized_bls12_381 import G1, G2, multiply, curve_order as R, FQ, FQ2, pairing
...
def g2_to_bytes_jac(P): x,y,z=P; return fq2_to_bytes(x)+fq2_to_bytes(y)+fq2_to_bytes(z)
